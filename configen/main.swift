...
let plistDictionary = parser.plistDictionary()
let hintsDictionary = parser.hintsDictionary()

if parser.isObjC {
  
}

let outputClassHeaderName = "\(parser.outputClassDirectory)/\(parser.outputClassName).h"
